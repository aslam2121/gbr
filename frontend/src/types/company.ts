export interface UserProfile {
  ...
  continent: string;
  country: string;
  name_of_the_company: string | null;
  foundation_year: number | null;
  location_of_headquarters: string | null;
  location_of_branches: string | null;
  area_of_specification: string | null;
  annual_revenue_data: unknown | null;
  requirements_for_partnership: string | null;
  existing_partners: string | null;
  type_of_investor: string | null;
  investment_policies: string | null;
  investment_policies_file: unknown | null;
  eligibility_criteria: string | null;
  date_of_birth: string | null;
  field_of_expertise: string | null;
  specialisation_on_selected_field: string | null;
  years_of_experience: number | null;
  work_experience_description: string | null;
  cv_biography: unknown | null;
  consultation_fee: number | null;
  any_other_details: string | null;
...
/** Backward-compatible alias — directory/map components use this */
export type Company = UserProfile;

/** Map area_of_specification enum to human-readable label */
export const AREA_LABELS: Record<string, string> = {
  "Health": "Health",
  "Financial Services": "Financial Services",
  "IT": "IT",
  "Consumer Products and Services": "Consumer Products",
  "Logistics and Transportation": "Logistics & Transport",
  "Business Products and Services": "Business Products",
  "Construction and Real Estate": "Construction & Real Estate",
  "Trading": "Trading",
...
/** Country name → approximate [lat, lng] for map positioning */
