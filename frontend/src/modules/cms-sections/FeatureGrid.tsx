import { type PageSection, type FeatureItem } from "@/types/page-section";
...
function getIcon(name: string) {
  return ICON_MAP[name] ?? ICON_MAP.directory;
}

export function FeatureGrid({ section }: FeatureGridProps) {
  const features = (section.metadata as { features?: FeatureItem[] })?.features ?? [];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <div key={i} className="rounded-xl bg-gray-50 p-6 transition-colors hover:bg-blue-50">
